...
YUZU_HASH="fd319234711413d77b338f03988ef491d61390ca"

DESCRIPTION="An emulator for Nintendo Switch"
HOMEPAGE="https://yuzu-emu.org"
SRC_URI="https://github.com/yuzu-emu/yuzu-mainline/archive/${YUZU_HASH}.tar.gz
		-> ${P}.tar.gz
	https://github.com/merryhime/dynarmic/archive/refs/tags/6.4.8.tar.gz
		-> ${PN}-dynarmic-${PV}.tar.gz
	https://github.com/herumi/xbyak/archive/refs/tags/v6.69.2.tar.gz
		-> ${PN}-xbyak-${PV}.tar.gz
...
SLOT="0"
KEYWORDS="~amd64"
IUSE="+cubeb discord +qt5 sdl +system-vulkan webengine webservice"
...
DEPEND="${RDEPEND}
	dev-cpp/cpp-httplib
	dev-cpp/cpp-jwt
	system-vulkan? ( >=dev-util/vulkan-headers-1.3.243 )
"
BDEPEND="
